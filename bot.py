...
# ======================== Bot sozlamalari ========================
BOT_USERNAME = "@Oldkinolarbot"
CHANNEL_USERNAME = "@kinolar_olami_botn1"
CHANNEL_URL = "https://t.me/kinolar_olami_botn1"
...
async def handle_code(update: Update, context: CallbackContext):
    ...
    if video:
        ...
        try:
            ...
            return
        links_msg = (
            f"📱 Instagram: https://www.instagram.com/kino_x_olami\n"
            f"📣 Kino kanal: @kinolar_olami_botn1 {CHANNEL_USERNAME}"
        )
